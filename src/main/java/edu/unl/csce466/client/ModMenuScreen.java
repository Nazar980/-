...
public class ModMenuScreen extends Screen {
    ...
    public ModMenuScreen() {
        super(findEmptyComponent());
    }

    private static Component findEmptyComponent() {
        try {
            ...
            LOGGER.error("[Mod] findEmptyComponent failed", t);
        }
        return null;
    }
    ...
    public void render(GuiGraphics g, int mouseX, int mouseY, float delta) {
        try { this.renderBackground(g, mouseX, mouseY, delta); } catch (Throwable ignored) {}
        ...
        try { super.render(g, mouseX, mouseY, delta); } catch (Throwable ignored) {}
    }

    @Override
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == org.lwjgl.glfw.GLFW.GLFW_KEY_L) { this.onClose(); return true; }
